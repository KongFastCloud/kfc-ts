/**
 * ABOUTME: Shell command execution for check/validation steps.
 * Spawns a command via sh -c, captures stdout/stderr.
 * Returns CmdResult on success (exit 0), throws CheckFailure on non-zero exit.
 */
