/**
 * ABOUTME: Git operations and GitHub CI integration for blueprints.
 * Provides commit, push, CI wait, and annotation fetching.
 * All operations are Effect-based with proper error tagging.
 */
